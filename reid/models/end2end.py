...
class AvgPooling(nn.Module):
    def __init__(self, input_feature_size, num_classes, embeding_fea_size=1024, dropout=0.5):
...
class End2End_AvgPooling(nn.Module):
    ...
    def __init__(self, pretrained=True, dropout=0, num_classes=0):
        ...
        self.avg_pooling = AvgPooling(input_feature_size=2048, num_classes=num_classes, dropout=dropout)
